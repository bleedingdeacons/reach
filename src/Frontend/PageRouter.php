...
/**
 * Wire the two Reach front-end pages into WordPress.
 *
 ...
 * the two PHP templates in templates/ directly.
 *
...
final class PageRouter
{
    ...
    public function renderPage(): void
    {
        ...
        $template = $page === 'signin'
            ? REACH_PLUGIN_DIR . 'templates/signin.php'
            : REACH_PLUGIN_DIR . 'templates/find.php';
