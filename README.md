...
[![Tests](https://github.com/bleedingdeacons/reach/actions/workflows/ci.yml/badge.svg)](https://github.com/bleedingdeacons/reach/actions/workflows/ci.yml)
...
`wp_unity_credentials`. Unity declares the contract,
...
after the upgrade — newest row wins, old tables left in
