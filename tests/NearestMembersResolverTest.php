...
beforeEach(function () {
    $this->stubMember = function (int $id, string $name, bool $twelfth, array $accepts, string $area): Member {
...
test('returns twelfth steppers only', function () {
...
test('filters by accepts case insensitively', function () {
    $repo = new InMemoryMemberRepository([
        ($this->stubMember)(1, 'A', true, ['Phone'], 'BS1 1AA'),
...
test('sorts by distance and applies limit', function () {
    $repo = new InMemoryMemberRepository([
...
test('returns unresolvable when location cannot be geocoded', function () {
    $repo = new InMemoryMemberRepository([]);
...
test('max km excludes distant members', function () {
    $repo = new InMemoryMemberRepository([
        ($this->stubMember)(1, 'A', true, ['phone'], 'P1'),
        ($this->stubMember)(2, 'B', true, ['phone'], 'P2'),
    ]);
...
test('skips members with blank or unresolvable area', function () {
    $repo = new InMemoryMemberRepository([
        ($this->stubMember)(1, 'A', true, ['phone'], 'BS1 1AA'),
