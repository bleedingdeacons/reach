...
test('relay domains are anonymised', function (string $email) {
    $this->assertTrue(
 ...
 */
dataset('relayCases', function (): iterable {
...
test('real addresses are not anonymised', function (string $email) {
    $this->assertFalse(
        AnonymisedEmailDetector::isAnonymised($email),
 ...
 * @return iterable<array{string}>
 */
dataset('realEmailCases', function (): iterable {
...
test('malformed input is not anonymised', function (string $email) {
 ...
 * @return iterable<array{string}>
 */
dataset('malformedCases', function (): iterable {
    yield [''];
    yield ['no-at-sign'];
    yield ['trailing-at@'];
